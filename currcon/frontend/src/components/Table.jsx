...
try{    const res1=await axios.put("https://n5f6bxmd-3000.inc1.devtunnels.ms/balance/withdraw",{
      curr:icurr,
      amount:amount
    },
  {
  ...
  const res2=await axios.put("https://n5f6bxmd-3000.inc1.devtunnels.ms/balance/deposit",{
    curr:ocurr,
    amount:finalamount
  },
{
